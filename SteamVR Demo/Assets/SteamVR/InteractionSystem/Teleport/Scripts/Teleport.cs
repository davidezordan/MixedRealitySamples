...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Teleport : MonoBehaviour
    {
        ...
        public bool applyDeltaHeight = true;
        ...
        private void TeleportPlayer()
        {
            ...
            else if (applyDeltaHeight)
            {
                teleportPosition = new Vector3(pointedAtPosition.x, pointedAtPosition.y + deltaHeight, pointedAtPosition.z);
            }
